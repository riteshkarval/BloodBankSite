...
<?php
		...
		if (mysqli_connect_errno())
		  ...
		  echo "Failed to connect to MySQL: " . mysqli_connect_error();
		   ...
		   $result = mysqli_query($con,'SELECT max(id) FROM request');
		  ...
		  echo "<table border='1'>
			...
			echo "<tr>";
			  ...
			  echo "</tr>";
			echo "</table>";
		mysqli_query($con,'INSERT INTO request VALUES("'.$_POST['an'].'","'.$_POST['age'].'","'.$_POST['sex'].'","'.$_POST['city'].'","
		'.$_POST['hos'].'","'.$_POST['dis'].'","'.$_POST['bgroup'].'","'.$_POST['year'].'-'.$_POST['month'].'-'.$_POST['date'].'","'.$newid.'")');
		mysqli_query($con,'INSERT INTO login values("'.$newid.'","'.$pass.'","request")');
